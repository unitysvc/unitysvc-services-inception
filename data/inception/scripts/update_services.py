#!/usr/bin/env python3
"""
Simplified update_services.py for Inception using unitysvc_services data builders.
...
API_BASE_URL = "https://api.inceptionlabs.ai/v1/chat/completions"
...
class ModelExtractor:
    ...
    def build_offering(self, model_id: str, model_info: dict) -> OfferingDataBuilder:
        ...
        builder.add_upstream_interface(f"{DISPLAY_NAME} API", base_url=API_BASE_URL,
            api_key="${ secrets.INCEPTION_API_KEY }",
            rate_limits=[])
        return builder
    ...
    def build_listing(self, model_id: str) -> ListingDataBuilder:
        ...
        builder.set_raw("service_options", {"default_parameters": {"api_key": "${ secrets.INCEPTION_API_KEY }"}})
